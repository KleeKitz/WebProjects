...
var buttonUpgrade2: HTMLButtonElement;
var boughtUpgrade2 = false;
var button2Shown = false;

var psUpgrade1Button: HTMLButtonElement;
...
function getLsOrDefault(itemName, defaultVal): string {
...
function getLsOrDefaultInt(itemName, defaultVal): number {
    var value = localStorage.getItem(itemName);
    if (value) {
...
function showUpgrade2() {
    if (!button2Shown) {
        ...
        buttonUpgrade2.onclick = (e) => tryBuyUpgrade2()
...
function showPSUpgrade1() {
    if (!psUpgradeButton1Shown) {
        ...
        psUpgrade1Button.onclick = (e) => tryBuyPSUpgrade1()
